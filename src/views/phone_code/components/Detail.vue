    ...
    <div class="detail-container">
      <el-row>
        <el-col :span="24">
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item prop="code" label="车牌编码：" :label-width="labelWidth">
                <el-input
...
import { getCode } from '../../../api/phone_code'
...
export default {
  ...
  methods: {
    ...
    submitForm() {
      if (!this.isEdit) {
        this.$store.dispatch('phone_code/add', this.postForm)
          .then((msg) => {
            this.$notify({
              title: '操作成功',
              message: msg.data,
        ...
        this.$store.dispatch('phone_code/update', this.postForm)
          .then((msg) => {
            this.$notify({
              title: '操作成功',
              message: msg.data,
